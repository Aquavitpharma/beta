...
<div id="cart" style="top:-25px; right:100px;">
  <div class="heading" style="margin-top:auto; margin-right:20px;">
  ...
  <div class="content">
    ...
    <div class="mini-cart-info">
      <table>
        ...
        <tr>
          <td class="image" style="float:none;"><?php if ($product['thumb']) { ?>
        ...
        <tr>
          <td class="image" style="float:none;"></td>
