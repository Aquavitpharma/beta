  ...
  <div class="shadow_bg">
    ...
    <div class="mid_center">
      ...
      <div class="button_box" style="margin-top:-50px; margin-left:180px;">        
        <input type="button" value="Order your own giftcards" class="giftCardButton active" onclick="location.href='<?php echo $voucher; ?>';">
        ...
        <div class="gift_container">
          ...
          <div class="gift_form">
            ...
            <div class="form_box2">
              ...
              <input name="is_email" type="checkbox" value="1" class="check-show2"> <!--Email activation code to-->Email me the activation code <br />
              <input name="to_email" id="to_email" type="email" class="gift_input small_input2" placeholder="Email address" value="" style="display:none;"> <br />
              <i>Free</i>
            ...
            <input type="hidden" name="from_email" id="from_email" value="<?php echo $from_email; ?>" />
            <?php } else { ?>
            ...
            <?php } ?>
            <div class="form_box2">
              <label>Denomination&#042; <!--<?php if ($type == 1) { ?><br /> Discount Rate 0% <br /> <a href="<?php echo $discount; ?>" style="color: #FF0000;">Set discount rate&#042;</a><?php } ?>--></label>
              <!--<span>
              ...
              <?php if ($discount_rate) { ?> Currently at <?php echo (int)$discount_rate; ?>% <?php } else echo 'You have not set up your discount rate yet'; ?> &nbsp;	<a href="<?php echo ($discount_rate) ? $discount : $discount.'/insert'; ?>" style="color: #FF0000;">Set discount rate&#042;</a>
              </div>
              <?php } ?>
          </div>
          <div class="gift_form" style="width:auto;">
