        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="quantity"><!--<input type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" onblur="this.form.submit();" />-->
              ...
              <option value="20" <?php if($product['quantity'] == 20) echo 'selected'; 
              ?>> Consumer model: 1 case (20 units)   </option>
              <option value="20" <?php if($product['quantity'] == 20) echo 'selected';
              ?>> Professional model: 1 case (20 units)  </option>
              <option value="3" <?php if($product['quantity'] == 3) echo 'selected';
               ?>>Professional model: Trial pack (3 units)  </option>
             </select>
              <!--&nbsp;
