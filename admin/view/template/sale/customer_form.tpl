        ...
        <div id="tab-general">
          ...
          <div id="tab-address-<?php echo $address_row; ?>" class="vtabs-content">
            ...
            <table class="form">
              ...
              <tr>
                <td>Website:</td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][website]" value="<?php echo $address['website']; ?>" /></td>
              </tr>
...
function addAddress() {	
	...
	html += '    <tr>';
    html += '      <td>Website</td>';
    html += '      <td><input type="text" name="address[' + address_row + '][website]" value="" /></td>';
    html += '    </tr>';	
