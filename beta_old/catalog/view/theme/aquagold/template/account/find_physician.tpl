...
<!--Section Start: -->
  ...
  <br><br>
    ...
    <div><b>Dr. David Goldberg</b></div>
	  ...
	  <div><a href="http://youtu.be/fMc_FFK1MVc" target="_blank">Video</a>
		<div style="float:right;">
    ...
    <div><b>Dr. Daniel A. DelVecchio</b></div>
	  ...
	  <div><a href="http://www.theplasticsurgerychannel.com/new-needline-device-unveiled-is-the-procedure-right-for-you/" target="_blank">Video</a>
      <div style="float:right;">
