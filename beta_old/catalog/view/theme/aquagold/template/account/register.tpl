...
<!--Section Start: -->
  ...
  <div class="shadow_bg">
    ...
    <div class="regist_center">
      <div style="float: left;" class="registration_box">
	...
	<img style="float:right; margin-right: 14cm; margin-top:3cm;" src="catalog/view/theme/aquagold/image/Aquagold_vial.png" width="150px">
  </div>
  </section>
