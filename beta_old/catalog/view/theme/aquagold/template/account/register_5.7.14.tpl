      ...
      <div class="registration_box">
        ...
        <div class="form_box1" style="margin-bottom:0;">
          <label>Referred by
            ...
            <input name="referred_by" id="referred_by" type="text" class="small_input" placeholder="Name" style="display:none; margin-top:2px;"> <br>Accout type
          </label>
        </div>
        <div class="form_box1">
        ...
        <div class="form_box1" id="message1" style="display:none;" >
          ...
          <input name="license_number" id="license_number" type="text" class="input_regis" />
        </div>
        <div class="form_box1">
