        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="quantity"><!--<input type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" onblur="this.form.submit();" />-->
              ...
              <!--&nbsp;<a href="<?php echo $product['remove']; ?>"><img src="catalog/view/theme/default/image/remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a>--><a href="<?php echo $product['remove']; ?>" style="float:right; color:#000000;">Remove</a></td>
          ...
          <tr>
            ...
            <td class="quantity"><input type="text" name="" value="1" size="1" disabled="disabled" />
              <!--&nbsp;<a href="<?php echo $vouchers['remove']; ?>"><img src="catalog/view/theme/default/image/remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a>--><a href="<?php echo $vouchers['remove']; ?>" style="float:right; color:#000000;">Remove</a></td>
